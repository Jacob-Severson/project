...
class GUI:
    def __init__(self, window):
        ...
        self.label_no_input = Label(self.window,text="")
        ...
        self.label_no_input.grid(row=4,column=1)
    ...
    def clicked(self):
        ...
        :return: none
        """
        self.label_no_input.config(text="")
        self.label_error.config(text="")
        if self.entry_name.get()=="" or self.entry_age.get()=="":
            self.label_no_input.config(text="please fill all inputs")
        else:
            try:
